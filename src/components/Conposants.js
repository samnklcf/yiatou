...
let linkImg = "http://localhost:8000/";

const ContentHeaderNotif = ({ texte, bool = true }) => {
    return (
        <>
            <h1 className="titre">{texte}</h1>
            <div className="icones">
                {bool ? <Link to="/notifications">
...
const ContentHeaderAddDemande = () => {
    return (
        <>
            ...
            <h1 className="titre">Nouvelle Demande</h1>
            <div className="icones">
...
const ContentHeaderAddBusiness = ({ texte, link, bool = true }) => {
    return (
        <>
            <Link to={link}>
                <svg width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="m10.875 19.3l-6.6-6.6q-.15-.15-.213-.325Q4 12.2 4 12t.062-.375q.063-.175.213-.325l6.6-6.6q.275-.275.687-.288q.413-.012.713.288q.3.275.313.687q.012.413-.288.713L7.4 11h11.175q.425 0 .713.287q.287.288.287.713t-.287.712Q19 13 18.575 13H7.4l4.9 4.9q.275.275.288.7q.012.425-.288.7q-.275.3-.7.3q-.425 0-.725-.3Z" /></svg>
...
// <img src="./assets/image/nike.jpg" alt="chessure" />
// const properties = {
...
const Carousel = () => {
    return (
        <>
            ...
            <section className="text-center bg-light pt-3 pb-5 mt-3">
                <div className="carousel flickity-enabled is-draggable" data-flickity="{ &quot;wrapAround&quot;: true }" tabIndex="0">
                    <div className="flickity-viewport" style={{ height: "220px", touchAction: "pan-y" }}>
                        <div className="flickity-slider" style={{ left: "0px", transform: "translateX(17%)" }}>
                            <div className="carousel-cell is-selected" style={{ position: "absolute", left: "0px", transform: "translateX(0%)" }}></div>
                            <div className="carousel-cell" aria-hidden="true" style={{ position: "absolute", left: "0px", transform: "translateX(104.73%)" }}></div>
                            <div className="carousel-cell" aria-hidden="true" style={{ position: "absolute", "left": "0px", transform: "translateX(209.47%)" }}></div>
                            <div className="carousel-cell" aria-hidden="true" style={{ position: "absolute", left: "0px", transform: "translateX(314.2%)" }}></div>
                            <div className="carousel-cell" aria-hidden="true" style={{ position: "absolute", left: "0px", transform: "translateX(-104.73%)" }}></div>
                        </div>
                    </div>
                    ...
                    <ol className="flickity-page-dots">
                        <li className="dot is-selected" aria-label="Page dot 1" aria-current="step"></li>
...
const ContentHeaderBoutique = () => {
    return (
        <>
            <h1 className="titre">Vendeur</h1>
            <div className="icones">
                <Link to="/">
...
const Article = ({ attent = false, date = false }) => {

    return (
        <div className={"article-carte"}>
            <div className="header-article">
                <div className="img">
                    <img src={linkImg + "assets/image/nike.jpg"} alt="nike" />
                </div>
                <div className="texte">
                    <p className='prix'>55 000 FCFA</p>
                    <p className='nom'>Lorem, ipsum dolor.</p>
                </div>
            </div>
            <Descriptions />
            {attent ? <p className='date a'>Attente</p> : ""}
            {date ? <p className='date'>aujourd'hui a 11h30min</p> : ""}
        </div>
    );
};
        ...
        <div className={`p-shadow ${toggle ? "active" : ""}`}>
            <div className="proposer">
                ...
                <p className="date-demande">
                    Ce produit a été demandé à {date}.
                </p>
        ...
        <div className={active ? "galerie active" : "galerie"}>
            <div className="content-galerie">
                ...
                <div className="imgs-galerie">
                    {imgs.map((image) => (
                        <div className="img-gl i1">
                            <img src={`${linkImg}assets/image/${image}`} alt="" />
                        </div>
                    ))}
                ...
                {buttons ? <div className="btns-galerie">
                    <button className="ac">Accepter</button>
...
// function createGaleries(imgs = ["nike.jpg", "nike.jpg", "nike.jpg", "nike.jpg"]) {

//     imgs.forEach((img, i, array) => {
//         // return (
//         <div className={`img${i}`}>
//             <img src={`${linkImg}assets/image/${img}`} alt="img" />
//         </div>
//         // )
//     })
// }
...
const ActueleArticle = ({ img = "nike.jpg", nom = "Nike prox Max", prix = 250000, reaction = 0 }) => {
    return (
        <div className="content-actuelle">
            ...
            <div className="textes-actuelle">
                ...
                <p className='prix'>{prix.toLocaleString()} FCFA</p>
                {reaction ? <p className='reaction'><Link to="/reaction">{reaction} reactions</Link></p> : ""}
            </div>
        </div>
    );
};

const ConfirmeArticle = ({ img = "nike.jpg", nom = "Jordan", prix = 55000 }) => {
    return (
        <div className="contener-confirmer">
            <div className="img-confirmer c">
                <Link to="/mise-en-relation">
                    <img src={`${linkImg}assets/image/${img}`} alt="chessure" />
                </Link>
            </div>
            <div className="texte-confirmer c">
                <p className="prix c">{prix.toLocaleString()} FCFA</p>
                <p className="nom c">{nom}</p>
...
const Login = () => {
    return (
        <div>
            <form action="#" method="post" className='form login'>
                <div className="inputs">
                    <div className="input">
                        ...
                        <input type="tel" name="numero" id="numero" placeholder='074000000' />
                    </div>
                    <div className="input">
            ...
            <p className='link'>Vous n'avez pas de compte ? <Link to="/log/create">créez un compte</Link></p>
        </div>
    );
};
const Create = () => {
    return (
        <form action="#" method="post" className='form create'>
            ...
            <p className='link'>Vous avez déjà un compte ? <Link to="/log/login">Connectez-vous !</Link></p>
        </form>
    );
};
// page reactions
...
const SetPassword = () => {
    return (
        <form className='form-password' action="#" method="post">
            ...
            <button type='sumbmit'>Mettre à jour</button>
        </form>
    );
};
